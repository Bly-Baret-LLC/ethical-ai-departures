  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-accent-red text-white shadow-lg transition-transform hover:scale-105 hover:bg-[#781515] focus:outline-none focus:ring-2 focus:ring-accent-red focus:ring-offset-2 sm:h-auto sm:w-auto sm:px-5 sm:py-3"
      >
        <svg
